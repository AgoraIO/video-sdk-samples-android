...
public class CallQualityManager extends AuthenticationManager {
    ...
    protected IRtcEngineEventHandler getIRtcEngineEventHandler() {
        ...
        return new IRtcEngineEventHandler() {
            ...
            public void onLastmileQuality(int quality) {
                ((CallQualityManagerListener) mListener).onLastMileQuality(quality);
            }
            ...
            public void onNetworkQuality(int uid, int txQuality, int rxQuality) {
                ((CallQualityManagerListener) mListener).onNetworkQuality(
            ...
            public void onRemoteVideoStats(RemoteVideoStats stats) {
                ((CallQualityManagerListener) mListener).onRemoteVideoStats(
                        stats
                );
            }
            ...
            public void onUserJoined(int uid, int elapsed) {
                ...
                ((CallQualityManagerListener) mListener).onUserJoined(
                        uid
                );
            }
    ...
    public interface CallQualityManagerListener extends AgoraManager.AgoraManagerListener {
